...
@php
    ...
    $presentaJustificacion =
        $permiso->documento ? 'SI' : 'NO';
    ...
    $fechaTramite =
        \Carbon\Carbon::parse($permiso->created_at);
...
<div class="documento">
    ...
    <div class="header">
        ...
        <div class="header-content">
            ...
            <div class="subtitulo">
                FORMATO GENERAL PARA PERMISOS DE PRACTICANTES
            </div>
    ...
    <div class="section">
        ...
        <div class="form-row">
            ...
            <div class="form-group">
                <span class="form-label-inline">IDENTIDAD:</span>
        ...
        <div class="permisos">
            ...
            <span class="permiso-item">
                <span class="check-line">
                    {{ str_contains($tipo,'particular') || str_contains($tipo,'personal') ? 'X' : '' }}
                </span>
                PARTICULAR / PERSONAL
            </span>
            ...
            <span class="permiso-item">
                <span class="check-line">
                    {{ str_contains($tipo,'incapacidad') ? 'X' : '' }}
                </span>
                INCAPACIDAD
            </span>
            ...
            <span class="permiso-item">
                <span class="check-line">
                    {{ str_contains($tipo,'fúnebre') || str_contains($tipo,'funebre') ? 'X' : '' }}
                </span>
                PERMISO FÚNEBRE
            </span>
    ...
    <div class="observaciones">
        ...
        <div class="obs-title">
            <strong>
                OBSERVACIONES / MOTIVO DEL PERMISO:
            </strong>
        </div>
    ...
    <div class="signatures">
        ...
        <div class="firma-box">
            ...
            <strong>FIRMA PRACTICANTE</strong>
        </div>
