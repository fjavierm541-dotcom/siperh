...
@section('title', 'Permisos Practicantes')
...
<div class="container py-5">
    ...
    <h4 class="mb-0">Listado de Permisos de Practicantes</h4>

    <div class="d-flex gap-2">

            
        <a href="{{ route('permisos-practicantes.mis') }}" class="btn btn-gold">
            Mis permisos
        </a>
           ...
           @if(session('permiso_imprimir'))
            <script>
                window.addEventListener('load', function () {
                    setTimeout(function () {
                        window.open(
                            "{{ route('permisos-practicantes.imprimir', session('permiso_imprimir')) }}",
                            "_blank",
                            "noopener,noreferrer"
                        );
                    }, 500);
    ...
    <div class="row g-2 align-items-end">
        ...
        <div class="col-md-5">
            ...
            <input type="text"
                   ...
                   name="buscar"
                   class="form-control"
                   placeholder="Nombre, DNI, modalidad o tipo"
        ...
        <div class="col-md-3 d-flex gap-2">
            ...
            <a href="{{ route('permisos-practicantes.index') }}" class="btn btn-outline-secondary w-100">
                Limpiar
            </a>
        </div>
...
<script>
    function abrirModal(accion, id) {
        ...
        if (accion === 'aprobar') {
            ...
            form.action = "/permisos-practicantes/" + id + "/aprobar";
        }
        ...
        if (accion === 'rechazar') {
            ...
            form.action = "/permisos-practicantes/" + id + "/rechazar";
