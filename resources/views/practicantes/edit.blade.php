...
<div class="p-4 text-white"
    ...
    <h4 class="fw-bold mb-1">
        Actualización de información del practicante
    </h4>

    <small>
        Editar registro de estudiantes en práctica profesional.
    </small>
...
<link href="https://cdn.jsdelivr.net/npm/select2@4.1.0-rc.0/dist/css/select2.min.css" rel="stylesheet" />
    ...
    <form action="{{ route('practicantes.update', $practicante) }}"
      method="POST">
        ...
        <div class="row">
            ...
            <div class="col-md-6 mb-3">
                ...
                <input type="text"
                       ...
                       value="{{ old('nombre_completo', $practicante->nombre_completo) }}"
                       required
                       minlength="3"
                       maxlength="200">
            ...
            <div class="col-md-6 mb-3">
                ...
                <input type="text"
                       ...
                       value="{{ old('dni_practicante', $practicante->dni_practicante) }}"
                       required
                       minlength="13"
                       maxlength="13"
                       inputmode="numeric"
            ...
            <div class="col-md-6 mb-3">
                ...
                <input type="text"
                       ...
                       value="{{ old('institucion', $practicante->institucion) }}"
                       required
                       minlength="3"
                       maxlength="150">
            ...
            <div class="col-md-6 mb-3">
                ...
                <input type="email"
                       ...
                       value="{{ old('correo', $practicante->correo) }}"
                       maxlength="255"
            ...
            <div class="col-md-4 mb-3">
                ...
                <input type="date"
                       ...
                       value="{{ old('fecha_inicio', optional($practicante->fecha_inicio)->format('Y-m-d')) }}"
                       required>
            ...
            <div class="col-md-4 mb-3">
                ...
                <input type="date"
                       ...
                       value="{{ old('fecha_fin', optional($practicante->fecha_fin)->format('Y-m-d')) }}">
                ...
                <select name="departamento_id"
                    ...
                    @foreach($departamentos as $departamento)
                        ...
                        <option value="{{ $departamento->id }}"
                            {{ old('departamento_id', $practicante->departamento_id) == $departamento->id ? 'selected' : '' }}>
                            {{ $departamento->nombre }}
                        </option>
